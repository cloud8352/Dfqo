...
return function(data, texture)
    ...
    ps:setEmissionArea(data.areaSpread.distribution, unpack(data.areaSpread.distance), 0, 0, false)
    ...
    ps:setLinearAcceleration(data.linearAcceleration.min[1], data.linearAcceleration.min[2],
        data.linearAcceleration.max[1], data.linearAcceleration.max[2])
