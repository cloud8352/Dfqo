--[[
	desc: MountainLeanState, a state of fighter.
	author: keke
]]--
...
local MountainLeanState = require("core.class")(_Base)

function MountainLeanState:Ctor(data, ...)
    _Base.Ctor(self, data, ...)

    self.easeMoveParams = data.easemove
end

function MountainLeanState:Init(entity)
...
function MountainLeanState:NormalUpdate(dt, rate)
...
function MountainLeanState:Enter(lateState, skill)
...
function MountainLeanState:Exit(nextState)
