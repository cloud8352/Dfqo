--[[
	desc: SingleKick, a state of Fighter.
	author: keke
]]
--
...
---@class Actor.State.Duelist.Fighter.SingleKick:Actor.State
...
local SingleKick = require("core.class")(_Base)
...
function SingleKick:Init(entity)
...
function SingleKick:NormalUpdate(dt, rate)
...
function SingleKick:Enter(laterState, skill)
...
function SingleKick:Exit(nextState)
