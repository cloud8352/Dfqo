...
---@class Actor.State.Duelist.Fighter.Jump : Actor.State
---@field protected _skill Actor.Skill
---@field protected _effect Actor.Entity
local FighterJump = require("core.class")(JumpBase)

function FighterJump:NormalUpdate(dt, rate)
...
function FighterJump:UpdateJumpAttackLogic(currentFrameAni)    -- jump attack
...
function FighterJump:Enter(lastState, skill)
...
function FighterJump:Exit(nextState)
