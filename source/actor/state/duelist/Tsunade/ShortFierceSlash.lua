--[[
	desc: ShortFierceSlash, a state of Tsunade.
	author: keke
]]
--
...
---@class Actor.State.Duelist.Tsunade.ShortFierceSlash : Actor.State
---@field protected _attack Actor.Gear.Attack
---@field protected _skill Actor.Skill
---@field protected _buff Actor.Buff
local ShortFierceSlash = require("core.class")(_Base)

local HitStop = { 220, 110 }

function ShortFierceSlash:Ctor(data, ...)
    _Base.Ctor(self, data, ...)
end

function ShortFierceSlash:Init(entity)
...
function ShortFierceSlash:NormalUpdate(dt, rate)
...
function ShortFierceSlash:Enter(laterState, skill)
...
function ShortFierceSlash:Exit(nextState)
