--[[
	desc: NormalAttack, a state of Tsunade.
	author: keke
]]--
...
---@class Actor.State.Duelist.Tsunade.NormalAttack : Actor.State
...
function _NormalAttack:SetProcess(process)
    ...
    _SOUND.Play(self._soundDataSet.swing[process])
...
function _NormalAttack:EnterAttack()
    ...
    if self._process == 1 then
        soundData = self._soundDataSet.HitByHandle
    else
