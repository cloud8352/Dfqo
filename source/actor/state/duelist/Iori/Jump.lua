...
---@class Actor.State.Duelist.Iori.Jump : Actor.State
---@field protected _skill Actor.Skill
---@field protected _effect Actor.Entity
local IoriJump = require("core.class")(JumpBase)

function IoriJump:NormalUpdate(dt, rate)
    JumpBase.NormalUpdate(self, dt, rate)
end

---@param currentFrameAni Graphics.Drawable.Frameani
function IoriJump:UpdateJumpAttackLogic(currentFrameAni)    -- jump attack
...
function IoriJump:Enter(lastState, skill)
...
function IoriJump:Exit(nextState)
