...
---@class Actor.State.Duelist.Kyo.Jump : Actor.State
---@field protected _skill Actor.Skill
---@field protected _effect Actor.Entity
local KyoJump = require("core.class")(JumpBase)
...
function KyoJump:UpdateJumpAttackLogic(currentFrameAni)    -- jump attack
...
function KyoJump:Enter(lastState, skill)
...
function KyoJump:Exit(nextState)
